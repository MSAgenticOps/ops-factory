...
public class ApiExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleIllegalArgument(IllegalArgumentException ex) {
        ...
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
            .body(Map.of("code", "RESOURCE_NOT_FOUND", "message", ex.getMessage()));
    }
    ...
    public ResponseEntity<Map<String, Object>> handleIllegalState(IllegalStateException ex) {
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
            .body(Map.of("code", "REQUEST_FAILED", "message", ex.getMessage()));
    }
    ...
    public ResponseEntity<Map<String, Object>> handleConflict(ApiConflictException ex) {
        ...
        return ResponseEntity.status(HttpStatus.CONFLICT).body(Map.of("code", ex.code(), "message", ex.getMessage()));
    }
    ...
    public ResponseEntity<Map<String, Object>> handleRetrievalConfiguration(RetrievalConfigurationException ex) {
        ...
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
            .body(Map.of("code", "RETRIEVAL_CONFIGURATION_ERROR", "message", ex.getMessage()));
    }
