...
public class KnowledgeProperties {
    ...
    public static class Ingest {
        ...
        private List<String> allowedContentTypes =
            new ArrayList<>(List.of("application/pdf", "application/vnd.ms-htmlhelp", "application/chm",
                "application/x-chm", "application/vnd.openxmlformats-officedocument.wordprocessingml.document",
        ...
        public boolean isSkipExistingByDefault() {
            return skipExistingByDefault;
        }

        public void setSkipExistingByDefault(boolean skipExistingByDefault) {
            this.skipExistingByDefault = skipExistingByDefault;
        }
    }
    ...
    public static class Convert {
        ...
        public boolean isEnablePdfboxFallback() {
            return enablePdfboxFallback;
        }

        public void setEnablePdfboxFallback(boolean enablePdfboxFallback) {
            this.enablePdfboxFallback = enablePdfboxFallback;
        }
        ...
        public boolean isNormalizeFullHalfWidth() {
            return normalizeFullHalfWidth;
        }

        public void setNormalizeFullHalfWidth(boolean normalizeFullHalfWidth) {
            this.normalizeFullHalfWidth = normalizeFullHalfWidth;
        }

        public boolean isKeepMarkdownArtifact() {
            return keepMarkdownArtifact;
        }

        public void setKeepMarkdownArtifact(boolean keepMarkdownArtifact) {
            this.keepMarkdownArtifact = keepMarkdownArtifact;
        }
    }
    ...
    public static class Chunking {
        ...
        public boolean isKeepTablesWhole() {
            return keepTablesWhole;
        }

        public void setKeepTablesWhole(boolean keepTablesWhole) {
            this.keepTablesWhole = keepTablesWhole;
        }

        public boolean isSplitLongParagraphs() {
            return splitLongParagraphs;
        }

        public void setSplitLongParagraphs(boolean splitLongParagraphs) {
            this.splitLongParagraphs = splitLongParagraphs;
        }

        public boolean isMergeShortParagraphs() {
            return mergeShortParagraphs;
        }

        public void setMergeShortParagraphs(boolean mergeShortParagraphs) {
            this.mergeShortParagraphs = mergeShortParagraphs;
        }
    ...
    public static class Metadata {
        ...
        public boolean isExtractTitlePath() {
            return extractTitlePath;
        }

        public void setExtractTitlePath(boolean extractTitlePath) {
            this.extractTitlePath = extractTitlePath;
        }
        ...
        public boolean isStorePageRefs() {
            return storePageRefs;
        }

        public void setStorePageRefs(boolean storePageRefs) {
            this.storePageRefs = storePageRefs;
        }
    }
    ...
    public static class Indexing {
        ...
        public double getTitlePathBoost() {
            return titlePathBoost;
        }

        public void setTitlePathBoost(double titlePathBoost) {
            this.titlePathBoost = titlePathBoost;
        }
        ...
        public boolean isStoreMarkdown() {
            return storeMarkdown;
        }

        public void setStoreMarkdown(boolean storeMarkdown) {
            this.storeMarkdown = storeMarkdown;
        }
    }
    ...
    public static class Retrieval {
        ...
        public double getLexicalThreshold() {
            return lexicalThreshold;
        }

        public void setLexicalThreshold(double lexicalThreshold) {
    ...
    public static class Fetch {
        ...
        public boolean isIncludeNeighborsByDefault() {
            return includeNeighborsByDefault;
        }

        public void setIncludeNeighborsByDefault(boolean includeNeighborsByDefault) {
            this.includeNeighborsByDefault = includeNeighborsByDefault;
        }

        public int getDefaultNeighborWindow() {
            return defaultNeighborWindow;
        }

        public void setDefaultNeighborWindow(int defaultNeighborWindow) {
            this.defaultNeighborWindow = defaultNeighborWindow;
        }

        public int getMaxNeighborWindow() {
            return maxNeighborWindow;
        }

        public void setMaxNeighborWindow(int maxNeighborWindow) {
            this.maxNeighborWindow = maxNeighborWindow;
        }
    }
    ...
    public static class Retrieve {
        ...
        public void setExpandContext(boolean expandContext) {
        ...
        public int getMaxEvidenceCount() {
    ...
    public static class Features {
        ...
        public boolean isAllowChunkEdit() {
            return allowChunkEdit;
        }

        public void setAllowChunkEdit(boolean allowChunkEdit) {
            this.allowChunkEdit = allowChunkEdit;
        }

        public boolean isAllowChunkDelete() {
            return allowChunkDelete;
        }

        public void setAllowChunkDelete(boolean allowChunkDelete) {
            this.allowChunkDelete = allowChunkDelete;
        }
        ...
        public void setAllowExplain(boolean allowExplain) {
