...
/**
 * The MaintenanceJobFailureRepository.
 *
 * @author x00000000
 * @since 2026-05-26
 */
...
public class MaintenanceJobFailureRepository {
    ...
    private FailureRecord map(ResultSet rs, int rowNum) throws SQLException {
        return new FailureRecord(rs.getString("id"), rs.getString("job_id"), rs.getString("source_id"),
            rs.getString("document_id"), rs.getString("document_name"), rs.getString("stage"),
            rs.getString("error_code"), rs.getString("message"), Instant.parse(rs.getString("finished_at")));
    }

    public record FailureRecord(String id, String jobId, String sourceId, String documentId, String documentName,
        String stage, String errorCode, String message, Instant finishedAt) {
    }
}
