...
class RetrievalMachineControllerTest {
    ...
    void testSearch() {
        RetrievalMachineController controller = new RetrievalMachineController(facade);
        BaseRetrievalController.SearchRequest request =
            new BaseRetrievalController.SearchRequest("test query", List.of(), List.of(), null, 10, null, null);
        BaseRetrievalController.SearchResponse expectedResponse =
            new BaseRetrievalController.SearchResponse("test query", List.of(), 0);
    ...
    void testCompare() {
        RetrievalMachineController controller = new RetrievalMachineController(facade);
        var request =
            new BaseRetrievalController.CompareSearchRequest("test query", List.of(), List.of(), null, null, List.of());
        var expectedResponse = new BaseRetrievalController.CompareSearchResponse("test query", 10, null, null, null);
    ...
    void testFetch() {
        ...
        var expectedResponse = new BaseRetrievalController.FetchResponse(chunkId, null, null, null, List.of(), null,
            null, List.of(), null, null, null, null, List.of());
    ...
    void testRetrieve() {
        RetrievalMachineController controller = new RetrievalMachineController(facade);
        var request = new BaseRetrievalController.RetrieveRequest("test query", List.of(), null, 10, null);
        var expectedResponse = new BaseRetrievalController.RetrieveResponse("test query", List.of());
    ...
    void testExplain() {
        RetrievalMachineController controller = new RetrievalMachineController(facade);
        var request = new BaseRetrievalController.ExplainRequest("test query", "chunk-id", List.of(), null);
        var expectedResponse = new BaseRetrievalController.ExplainResponse("test query", "chunk-id", null, null, null);
