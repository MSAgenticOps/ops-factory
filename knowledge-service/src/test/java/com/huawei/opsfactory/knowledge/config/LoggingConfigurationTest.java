...
@SpringBootTest(properties = {"knowledge.runtime.base-dir=target/test-runtime-logging-config",
    "logging.level.root=ERROR", "logging.level.com.huawei.opsfactory.knowledge=INFO",
...
class LoggingConfigurationTest {
    ...
    void shouldLoadLogbackConfigurationAndApplyConfiguredLevels() {
        ...
        try (TestLogAppender embeddingAppender = TestLogAppender.attachTo(EmbeddingService.class);
            ...
            assertThat(embeddingAppender.formattedMessages()).anyMatch(
