...
/**
 * Base controller for executing and risk-checking remote commands on managed hosts.
 *
 * @author x00000000
 * @since 2026-06-06
 */
public abstract class BaseRemoteExecController {
    protected final RemoteExecutionService remoteExecutionService;
    protected final CommandWhitelistService commandWhitelistService;
