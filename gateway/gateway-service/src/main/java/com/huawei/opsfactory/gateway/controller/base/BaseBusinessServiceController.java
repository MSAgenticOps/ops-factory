...
/**
 * Base controller for CRUD operations on business service definitions.
 *
 * @author x00000000
 * @since 2026-06-06
 */
public abstract class BaseBusinessServiceController {
    protected final BusinessServiceService businessServiceService;

    /**
     * Creates the base business service controller instance.
     *
     * @param businessServiceService service handling business service CRUD operations
     */
    public BaseBusinessServiceController(BusinessServiceService businessServiceService) {
