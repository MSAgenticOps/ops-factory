...
/**
 * Base controller for managing cluster-to-cluster relation edges and graph queries.
 *
 * @author x00000000
 * @since 2026-06-06
 */
public abstract class BaseClusterRelationController {
    protected final ClusterRelationService clusterRelationService;

    /**
     * Creates the base cluster relation controller instance.
     *
     * @param clusterRelationService service handling cluster relation CRUD operations
     */
    public BaseClusterRelationController(ClusterRelationService clusterRelationService) {
