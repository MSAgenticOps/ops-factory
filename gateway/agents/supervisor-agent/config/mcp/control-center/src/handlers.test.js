...
function mockFetch(input, init = {}) {
  ...
  return Promise.resolve(
    new Response(`Not found: ${method} ${path}`, { status: 404 }),
  );
}
...
describe('read-only handlers', () => {
  ...
  it('handleGetObservabilityData should fetch observability payloads', async () => {
    routes['/control-center/observability/status'] = {
      enabled: true,
      reachable: true,
  ...
  it('handleGetRealtimeMetrics should return runtime metrics', async () => {
    routes['/control-center/runtime/metrics'] = {
  ...
  it('handleGetServiceStatus should require serviceId', async () => {
    routes['/control-center/services/gateway'] = {
      id: 'gateway',
      status: 'healthy',
    };
  ...
  it('handleReadServiceLogs should pass lines', async () => {
    routes['/control-center/services/gateway/logs'] = {
      content: 'line1\nline2',
    };
  ...
  it('handleReadServiceConfig should return config payload', async () => {
    routes['/control-center/services/gateway/config'] = {
      content: 'server:\n  port: 3000',
    };
...
describe('action handlers', () => {
  it('handleStartService should POST start action', async () => {
    routes['POST /control-center/services/gateway/actions/start'] = {
      success: true,
      action: 'start',
    };
  ...
  it('handleStopService should POST stop action', async () => {
    routes['POST /control-center/services/gateway/actions/stop'] = {
      success: true,
      action: 'stop',
    };
  ...
  it('handleRestartService should POST restart action', async () => {
    routes['POST /control-center/services/gateway/actions/restart'] = {
      success: true,
      action: 'restart',
    };
...
describe('dispatch', () => {
  ...
  it('should route read_service_logs', async () => {
    ...
    const result = JSON.parse(
      await dispatch('read_service_logs', { serviceId: 'gateway', lines: 10 }),
    );
  ...
  it('should route restart_service', async () => {
    ...
    const result = JSON.parse(
      await dispatch('restart_service', { serviceId: 'gateway' }),
    );
    assert.equal(result.action, 'restart');
  });
