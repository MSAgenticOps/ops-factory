...
public class OperationIntelligenceProperties {
    ...
    public static class Qos {
        ...
        public List<DvEnvironment> getDvEnvironments() { return dvEnvironments; }
        public void setDvEnvironments(List<DvEnvironment> dvEnvironments) { this.dvEnvironments = dvEnvironments; }
