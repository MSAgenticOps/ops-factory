...
package com.huawei.opsfactory.operationintelligence.controller.base;
...
/**
 * Base knowledge graph controller containing shared logic.
 *
 * @author x00000000
 * @since 2026-06-06
 */
public abstract class BaseKnowledgeGraphController {
    private static final ObjectMapper OBJECT_MAPPER = new ObjectMapper();

    protected final KnowledgeGraphService knowledgeGraphService;

    /**
     * Constructs a BaseKnowledgeGraphController.
     *
     * @param knowledgeGraphService the knowledge graph service
     */
    public BaseKnowledgeGraphController(KnowledgeGraphService knowledgeGraphService) {
     ...
     */
    protected Map<String, Object> ok(String key, Object value) {
