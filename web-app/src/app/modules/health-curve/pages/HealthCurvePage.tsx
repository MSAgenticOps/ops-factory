...
import HealthCurveFilters from '../components/HealthCurveFilters'
...
import '../styles/health-curve.css'

type DetailTab = 'availability' | 'performance' | 'alarm'

export default function HealthCurvePage() {
    ...
    const tabs: { key: DetailTab; label: string }[] = [
        { key: 'availability', label: t('healthCurve.availabilityDetail') },
        { key: 'performance', label: t('healthCurve.performanceDetail') },
        { key: 'alarm', label: t('healthCurve.alarmDetail') },
    ]

    return (
        <div className="page-container page-shell-wide health-curve-page">
            <div className="mon-page-header">
                <div className="mon-header-left">
                    <h1 className="page-title" style={{ marginBottom: 0 }}>{t('healthCurve.title')}</h1>
                </div>
                <HealthCurveFilters
                    envCode={envCode}
            ...
            <div className="mon-section">
                <h2 className="ui-section-title">{t('healthCurve.healthCurve')}</h2>
                <HealthCurveChart points={points} loading={loading} />
            </div>
            ...
            <div className="mon-section">
                <h2 className="ui-section-title">{t('healthCurve.topology')}</h2>
